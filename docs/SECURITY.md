...
user's own decision 2, 2026-09-24; see [RELIABILITY.md](RELIABILITY.md#known-limits)). Since 2026-09-26 a gate
deferral (a morning appointment until 22:00, or `3시간 미루기` once a day) makes settings and the backup reachable
until the deferral ends; the filter is now `gateAdmits`, which admits no settings sheet.
