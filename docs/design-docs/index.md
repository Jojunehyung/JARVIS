...
| [assistant-bridge.md](assistant-bridge.md) | Agenda buckets, the daily-briefing rules, the three bridge packets (daily check-in, `오늘 업무 만들기`, and `AI에게 회의 준비 묻기` since schema v27) and what the assistant never does |
