...
| 2026-09-08 | Harness-engineering layout: `AGENTS.md` routing, seven subagents, hooks (prompt-first, data-guard, lang-check, finish-check), `tools/harness`, English documentation; Korean originals retired after tag `ko-docs-final`. Prompt-first protocol and mandatory cleanup pass adopted. | [active plan](../exec-plans/active/2026-09-08-harness-restructure.md) |
